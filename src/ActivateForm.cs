...
namespace HighlightHelper {
    public partial class ActivateForm : Form {
        readonly List<HighlightProfile> hl;

        public ActivateForm(List<HighlightProfile> hlr) {
            InitializeComponent();
            hl = hlr;
        }
        ...
        private void btnActive_Click(object sender, EventArgs e) {
            ...
            HighlightProfile.ActivateStart();
            activeList.CheckedItems.OfType<HighlightProfile>().ToList().ForEach((i) => {
                i.Activate(ref a, ref b, ref c);
                A += a; B += b; C += c;
            });
